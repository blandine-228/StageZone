                            ...
                            <ul class="tours_list">
                                ...
                                <?php 
                                    ...
                                    $nom = $_SESSION["nom"];
                                        ...
                                        $content = "L'Etudiant ".$nom." a postulé pour votre stage ".$donnee['contenu_stage']."";
                                        ...
                                        <li class="d-flex flex-row align-items-start justify-content-start">
                                            <div class="tour_info">
                                             ...
                                             <form class="ml-auto" action="post_postuler.php" methode="GET">
                                             <input class="button tour_button" type="submit" value="Postuler"></input>
                                             <input name="email" value="'.$donnee['email'].'" hidden></input>
